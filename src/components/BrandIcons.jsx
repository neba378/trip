// Inline brand/social SVG icons. The installed lucide-react build omits brand
// glyphs (Instagram/Facebook/YouTube/TikTok), so we ship our own to stay
// independent of the icon library's version.
